...
![[Picture/a82d378db040365d3c1d071e7e6e0532_MD5.png]]

这是 Java 极客技术的第 265 篇原创文章
...
消息：Kafka 中的数据单元被称为`消息`，也被称为记录，可以把它看作[数据库](https://cloud.tencent.com/solution/database?from_column=20065&from=20065)表中某一行的记录。
...
![[Picture/24ffcedd972c046b166d35782e414bb5_MD5.png]]
...
![[Picture/c4dd8ed63b964ebe19e9c14e05e0b3c3_MD5.jpg]]
...
![[Picture/9c1c71ed4493b8f28f28c6f97b7187c7_MD5.png]]

点对点模式的消息队列

如果一个生产者或者多个生产者产生的消息能够被多个消费者同时消费的情况，这样的消息队列成为发布订阅模式的消息队列

![[Picture/418babee50440d5ebcf2b41f5f57814c_MD5.jpg]]

发布-订阅模式的消息队列

### **Kafka 系统架构**

![[Picture/938fe5a455517476bb78f517f4050ea4_MD5.jpg]]
...
![[Picture/30d563091a946767070b9d1f0ba97d83_MD5.jpg]]
...
![[Picture/3c313e0688797863b2868f08d1f6a38b_MD5.png]]
...
```
public interface Partitioner extends Configurable, Closeable {    public int partition(String topic, Object key, byte[] keyBytes, Object value, byte[] valueBytes, Cluster cluster);
...
![[Picture/f36788fd875791cb03fe714f061e6a14_MD5.png]]
...
![[Picture/60126d43bb61d415bff5fe47d1635e2a_MD5.jpg]]
...
![[Picture/016843603ecb4539ec8fe831cecc92b9_MD5.jpg]]
...
在上一篇文章 [**带你涨姿势的认识一下kafka**](https://cloud.tencent.com/developer/tools/blog-entry?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzU2NDg0OTgyMA%3D%3D%26mid%3D2247484570%26idx%3D1%26sn%3D1ad1c96bc7d47b88e976cbd045baf7d7%26chksm%3Dfc45f969cb32707f882c52d7434b2c0bf2ccbbc2cd854e1dc5c203deb8ae9c1831cf216e8bad%26token%3D343157109%26lang%3Dzh_CN%26scene%3D21%23wechat_redirect)中，我们主要介绍了一下 kafka 集群搭建的参数，本篇文章我们来介绍一下 Kafka 生产者重要的配置，生产者有很多可配置的参数，在文档里（http://kafka.apache.org/documentation/#producerconfigs）都有说明，我们介绍几个在内存使用、性能和可靠性方面对生产者影响比较大的参数进行说明
...
![[Picture/303bed40d77bc276630063bf2b9c9c54_MD5.jpg]]

![[Picture/9f3960c7065b041b8cef11648986c2f5_MD5.jpg]]
...
![[Picture/ac2fea3d2374019a9153d4641aebfa36_MD5.jpg]]
...
![[Picture/3dd38a662af98b5983d4b71f5eb00501_MD5.jpg]]

这样一来，消费者的消费能力就大大提高了，但是在某些环境下比如用户产生消息特别多的时候，生产者产生的消息仍旧让消费者吃不消，那就继续增加消费者。

![[Picture/b3e821b731e611bbffb7c2be449a30c2_MD5.jpg]]

如上图所示，每个分区所产生的消息能够被每个消费者群组中的消费者消费，如果向消费者群组中增加更多的消费者，那么多余的消费者将会闲置，如下图所示

![[Picture/785e2471da4453c81c754e0d23c11bc3_MD5.jpg]]
...
![[Picture/424239318a7b3187b146d8fdf481d116_MD5.jpg]]
...
![[Picture/e44da0644f3b8e9d4a310d8990d01464_MD5.jpg]]
...
这三个属性我们已经用过很多次了，如果你还不是很清楚的话，可以参考 [**带你涨姿势是认识一下Kafka Producer**](https://cloud.tencent.com/developer/tools/blog-entry?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzU3NzczMTAzMg%3D%3D%26mid%3D2247486038%26idx%3D1%26sn%3D473f25a5282a376486f09d4a9eff7b23%26scene%3D21%23wechat_redirect)
...
![[Picture/bdad28678cf2c0801f3fa551e8a5e52e_MD5.jpg]]
